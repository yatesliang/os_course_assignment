...
OBJS		= kernel/kernel.o lib/syscall.o kernel/start.o kernel/main.o\
			...
			applications/calculator.o applications/2048.o applications/pickstick.o applications/clearMine.o applications/guess.o\
...
applications/pickstick.o: applications/pickstick.c
	$(CC) $(CFLAGS) -o $@ $<
